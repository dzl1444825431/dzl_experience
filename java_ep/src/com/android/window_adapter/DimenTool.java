package com.android.window_adapter;
 ...
 * 注意用dp和sp，不要用dip，否则生成可能会出错；xml值不要有空格 Created by zhangxitao on 15/9/22.
 */
public class DimenTool {

	public static void gen() {

		File file = new File("D:\\baiduYun\\baiduYun-dzl-office-150810\\java\\src\\com\\android\\window_adapter\\dimens.xml");
	...
	public static void writeFile(String file, String text) {
		System.out.println("resp1onse : text = " + text);
