...
public class CustomRelativeLayout extends ViewGroup {
    ...
    public CustomRelativeLayout(Context context) {
        this(context, null);
		System.out.println("resp1onse CustomRelativeLayout: public CustomRelativeLayout(Context context) { start constructor ");
		System.out.println("resp1onse CustomRelativeLayout: public CustomRelativeLayout(Context context) { end constructor ");
    }

    public CustomRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
		System.out.println("resp1onse CustomRelativeLayout: public CustomRelativeLayout(Context context, AttributeSet attrs) { start constructor ");
		System.out.println("resp1onse CustomRelativeLayout: public CustomRelativeLayout(Context context, AttributeSet attrs) { end constructor ");
    }

    public CustomRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
		System.out.println("resp1onse CustomRelativeLayout: public CustomRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) { start constructor ");
	   
        initFromAttributes(context, attrs, defStyleAttr, 0);
        queryCompatibilityModes(context);
		System.out.println("resp1onse CustomRelativeLayout: public CustomRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) { end constructor ");
    }

    private void initFromAttributes(
            Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.CustomRelativeLayout, defStyleAttr, defStyleRes);
        mIgnoreGravity = a.getResourceId(R.styleable.CustomRelativeLayout_ignoreGravity, View.NO_ID);
        mGravity = a.getInt(R.styleable.CustomRelativeLayout_gravity, mGravity);
        a.recycle();
    }

    private void queryCompatibilityModes(Context context) {
		System.out.println("resp1onse CustomRelativeLayout: private void queryCompatibilityModes(Context context) { start void ");
		...
		System.out.println("resp1onse CustomRelativeLayout: private void queryCompatibilityModes(Context context) { end void ");
    }

    @Override
    public boolean shouldDelayChildPressedState() {
		System.out.println("resp1onse CustomRelativeLayout: public boolean shouldDelayChildPressedState() { start return ");
		System.out.println("resp1onse CustomRelativeLayout: public boolean shouldDelayChildPressedState() { end return ");
        return false;
    }
    ...
    public void setIgnoreGravity(int viewId) {
		System.out.println("resp1onse CustomRelativeLayout: public void setIgnoreGravity(int viewId) { start void ");
        mIgnoreGravity = viewId;
		System.out.println("resp1onse CustomRelativeLayout: public void setIgnoreGravity(int viewId) { end void ");
    }
    ...
    public int getGravity() {
		System.out.println("resp1onse CustomRelativeLayout: public int getGravity() { start return ");
		System.out.println("resp1onse CustomRelativeLayout: public int getGravity() { end return ");
        return mGravity;
    }
    ...
    public void setGravity(int gravity) {
		System.out.println("resp1onse CustomRelativeLayout: public void setGravity(int gravity) { start void ");
        if (mGravity != gravity) {
		...
		System.out.println("resp1onse CustomRelativeLayout: public void setGravity(int gravity) { end void ");
    }

    //@android.view.RemotableViewMethod
    public void setHorizontalGravity(int horizontalGravity) {
		System.out.println("resp1onse CustomRelativeLayout: public void setHorizontalGravity(int horizontalGravity) { start void ");
        final int gravity = horizontalGravity & Gravity.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        if ((mGravity & Gravity.RELATIVE_HORIZONTAL_GRAVITY_MASK) != gravity) {
            mGravity = (mGravity & ~Gravity.RELATIVE_HORIZONTAL_GRAVITY_MASK) | gravity;
            requestLayout();
        }
		System.out.println("resp1onse CustomRelativeLayout: public void setHorizontalGravity(int horizontalGravity) { end void ");
    }

    //@android.view.RemotableViewMethod
    public void setVerticalGravity(int verticalGravity) {
		System.out.println("resp1onse CustomRelativeLayout: public void setVerticalGravity(int verticalGravity) { start void ");
        final int gravity = verticalGravity & Gravity.VERTICAL_GRAVITY_MASK;
        if ((mGravity & Gravity.VERTICAL_GRAVITY_MASK) != gravity) {
            mGravity = (mGravity & ~Gravity.VERTICAL_GRAVITY_MASK) | gravity;
            requestLayout();
        }
		System.out.println("resp1onse CustomRelativeLayout: public void setVerticalGravity(int verticalGravity) { end void ");
    }

    @Override
    public int getBaseline() {
		System.out.println("resp1onse CustomRelativeLayout: public int getBaseline() { start return ");
		System.out.println("resp1onse CustomRelativeLayout: public int getBaseline() { end return ");
        return mBaselineView != null ? mBaselineView.getBaseline() : super.getBaseline();
    }

    @Override
    public void requestLayout() {
		System.out.println("resp1onse CustomRelativeLayout: public void requestLayout() { start void ");
        super.requestLayout();
        mDirtyHierarchy = true;
		System.out.println("resp1onse CustomRelativeLayout: public void requestLayout() { end void ");
    }

    private void sortChildren() {
		System.out.println("resp1onse CustomRelativeLayout: private void sortChildren() { start void ");
		...
		System.out.println("resp1onse CustomRelativeLayout: private void sortChildren() { end void ");
    }

    @Override
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		System.out.println("resp1onse CustomRelativeLayout: protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) { start void ");
        if (mDirtyHierarchy) {
		...
		System.out.println("resp1onse CustomRelativeLayout: protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) { end void ");
    }

    private static boolean isLayoutRtl() {
		System.out.println("resp1onse CustomRelativeLayout: private static boolean isLayoutRtl() { start return ");
		System.out.println("resp1onse CustomRelativeLayout: private static boolean isLayoutRtl() { end return ");
		return false;
	}

	private void alignBaseline(View child, LayoutParams params) {
		System.out.println("resp1onse CustomRelativeLayout: private void alignBaseline(View child, LayoutParams params) { start void ");
        final int layoutDirection = getLayoutDirection();
        int[] rules = params.getRules(layoutDirection);
		...
		System.out.println("resp1onse CustomRelativeLayout: private void alignBaseline(View child, LayoutParams params) { end void ");
    }
    ...
    private void measureChild(View child, LayoutParams params, int myWidth, int myHeight) {
		System.out.println("resp1onse CustomRelativeLayout: private void measureChild(View child, LayoutParams params, int myWidth, int myHeight) { start void ");
		...
		System.out.println("resp1onse CustomRelativeLayout: private void measureChild(View child, LayoutParams params, int myWidth, int myHeight) { end void ");
    }

    private void measureChildHorizontal(View child, LayoutParams params, int myWidth, int myHeight) {
		System.out.println("resp1onse CustomRelativeLayout: private void measureChildHorizontal(View child, LayoutParams params, int myWidth, int myHeight) { start void ");
        int childWidthMeasureSpec = getChildMeasureSpec(params.mLeft,
                params.mRight, params.width,
                params.leftMargin, params.rightMargin,
                getPaddingLeft(), getPaddingRight(),
        ...
        if (mMeasureVerticalWithPaddingMargin) {
            maxHeight = Math.max(0, myHeight - getPaddingTop() - getPaddingBottom() -
                    params.topMargin - params.bottomMargin);
        }
        ...
        child.measure(childWidthMeasureSpec, childHeightMeasureSpec);
		System.out.println("resp1onse CustomRelativeLayout: private void measureChildHorizontal(View child, LayoutParams params, int myWidth, int myHeight) { end void ");
    }
     ...
     * @param startPadding getPaddingLeft() or getPaddingTop()
     * @param endPadding getPaddingRight() or getPaddingBottom()
    ...
    private void applyHorizontalSizeRules(LayoutParams childParams, int myWidth, int[] rules) {
		System.out.println("resp1onse CustomRelativeLayout: private void applyHorizontalSizeRules(LayoutParams childParams, int myWidth, int[] rules) { start void ");
        CustomRelativeLayout.LayoutParams anchorParams;
		...
		System.out.println("resp1onse CustomRelativeLayout: private void applyHorizontalSizeRules(LayoutParams childParams, int myWidth, int[] rules) { end void ");
    }

    private void applyVerticalSizeRules(LayoutParams childParams, int myHeight) {
		System.out.println("resp1onse CustomRelativeLayout: private void applyVerticalSizeRules(LayoutParams childParams, int myHeight) { start void ");
		...
		System.out.println("resp1onse CustomRelativeLayout: private void applyVerticalSizeRules(LayoutParams childParams, int myHeight) { end void ");
    }

    private View getRelatedView(int[] rules, int relation) {
		System.out.println("resp1onse CustomRelativeLayout: private View getRelatedView(int[] rules, int relation) { start return ");
		...
		System.out.println("resp1onse CustomRelativeLayout: private View getRelatedView(int[] rules, int relation) { end return if ");
            return v;
        }

		System.out.println("resp1onse CustomRelativeLayout: private View getRelatedView(int[] rules, int relation) { end return  =1");
        return null;
    }

    private LayoutParams getRelatedViewParams(int[] rules, int relation) {
		System.out.println("resp1onse CustomRelativeLayout: private LayoutParams getRelatedViewParams(int[] rules, int relation) { start return ");
		...
		System.out.println("resp1onse CustomRelativeLayout: private LayoutParams getRelatedViewParams(int[] rules, int relation) { end return  =1");
        return null;
    }

    private int getRelatedViewBaseline(int[] rules, int relation) {
		System.out.println("resp1onse CustomRelativeLayout: private int getRelatedViewBaseline(int[] rules, int relation) { start return ");
        View v = getRelatedView(rules, relation);
        if (v != null) {
            return v.getBaseline();
        }
		System.out.println("resp1onse CustomRelativeLayout: private int getRelatedViewBaseline(int[] rules, int relation) { end return  =1");
        return -1;
    }

    private static void centerHorizontal(View child, LayoutParams params, int myWidth) {
		System.out.println("resp1onse CustomRelativeLayout: private static void centerHorizontal(View child, LayoutParams params, int myWidth) { start void ");
        int childWidth = child.getMeasuredWidth();
        int left = (myWidth - childWidth) / 2;

        params.mLeft = left;
        params.mRight = left + childWidth;
		System.out.println("resp1onse CustomRelativeLayout: private static void centerHorizontal(View child, LayoutParams params, int myWidth) { end void ");
    }

    private static void centerVertical(View child, LayoutParams params, int myHeight) {
		System.out.println("resp1onse CustomRelativeLayout: private static void centerVertical(View child, LayoutParams params, int myHeight) { start void ");
        int childHeight = child.getMeasuredHeight();
        int top = (myHeight - childHeight) / 2;

        params.mTop = top;
        params.mBottom = top + childHeight;
		System.out.println("resp1onse CustomRelativeLayout: private static void centerVertical(View child, LayoutParams params, int myHeight) { end void ");
    }

    @Override
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
		System.out.println("resp1onse CustomRelativeLayout: protected void onLayout(boolean changed, int l, int t, int r, int b) { start void ");
        ...
        for (int i = 0; i < count; i++) {
            View child = getChildAt(i);
            if (child.getVisibility() != GONE) {
                CustomRelativeLayout.LayoutParams st =
                        (CustomRelativeLayout.LayoutParams) child.getLayoutParams();
                child.layout(st.mLeft, st.mTop, st.mRight, st.mBottom);
            }
        }
		System.out.println("resp1onse CustomRelativeLayout: protected void onLayout(boolean changed, int l, int t, int r, int b) { end void ");
    }

    @Override
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams generateLayoutParams(AttributeSet attrs) { start return ");
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams generateLayoutParams(AttributeSet attrs) { end return ");
        return new CustomRelativeLayout.LayoutParams(getContext(), attrs);
    }
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
		System.out.println("resp1onse CustomRelativeLayout: protected ViewGroup.LayoutParams generateDefaultLayoutParams() { start return ");
		System.out.println("resp1onse CustomRelativeLayout: protected ViewGroup.LayoutParams generateDefaultLayoutParams() { end return ");
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
		System.out.println("resp1onse CustomRelativeLayout: protected boolean checkLayoutParams(ViewGroup.LayoutParams p) { start return ");
		System.out.println("resp1onse CustomRelativeLayout: protected boolean checkLayoutParams(ViewGroup.LayoutParams p) { end return ");
        return p instanceof CustomRelativeLayout.LayoutParams;
    }

    @Override
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
		System.out.println("resp1onse CustomRelativeLayout: protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) { start return ");
		System.out.println("resp1onse CustomRelativeLayout: protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) { end return ");
        return new LayoutParams(p);
    }

    @Override
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
		System.out.println("resp1onse CustomRelativeLayout: public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) { start return ");
		...
		System.out.println("resp1onse CustomRelativeLayout: public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) { end return if ");
                return true;
            }
        }

        mTopToBottomLeftToRightSet.clear();
		System.out.println("resp1onse CustomRelativeLayout: public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) { end return  =1");
        return false;
    }
...
//        event.setClassName(CustomRelativeLayout.class.getName());
//    }
//
//    @Override
//    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
//        super.onInitializeAccessibilityNodeInfo(info);
//        info.setClassName(CustomRelativeLayout.class.getName());
//    }
     ...
     */
     private class TopToBottomLeftToRightComparator implements Comparator<View> {
        public int compare(View first, View second) {
            // top - bottom
		System.out.println("resp1onse CustomRelativeLayout: public int compare(View first, View second) { start return ");
		...
		System.out.println("resp1onse CustomRelativeLayout: public int compare(View first, View second) { end return  =1");
            return 0;
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(Context c, AttributeSet attrs) { start constructor ");

            TypedArray a = c.obtainStyledAttributes(attrs,
                    R.styleable.CustomRelativeLayout_Layout);
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (attr) {
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignWithParentIfMissing:
                        alignWithParent = a.getBoolean(attr, false);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_toLeftOf:
                        rules[LEFT_OF] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_toRightOf:
                        rules[RIGHT_OF] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_above:
                        rules[ABOVE] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_below:
                        rules[BELOW] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignBaseline:
                        rules[ALIGN_BASELINE] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignLeft:
                        rules[ALIGN_LEFT] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignTop:
                        rules[ALIGN_TOP] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignRight:
                        rules[ALIGN_RIGHT] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignBottom:
                        rules[ALIGN_BOTTOM] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignParentLeft:
                        rules[ALIGN_PARENT_LEFT] = a.getBoolean(attr, false) ? TRUE : 0;
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignParentTop:
                        rules[ALIGN_PARENT_TOP] = a.getBoolean(attr, false) ? TRUE : 0;
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignParentRight:
                        rules[ALIGN_PARENT_RIGHT] = a.getBoolean(attr, false) ? TRUE : 0;
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignParentBottom:
                        rules[ALIGN_PARENT_BOTTOM] = a.getBoolean(attr, false) ? TRUE : 0;
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_centerInParent:
                        rules[CENTER_IN_PARENT] = a.getBoolean(attr, false) ? TRUE : 0;
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_centerHorizontal:
                        rules[CENTER_HORIZONTAL] = a.getBoolean(attr, false) ? TRUE : 0;
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_centerVertical:
                        rules[CENTER_VERTICAL] = a.getBoolean(attr, false) ? TRUE : 0;
                       break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_toStartOf:
                        rules[START_OF] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_toEndOf:
                        rules[END_OF] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignStart:
                        rules[ALIGN_START] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignEnd:
                        rules[ALIGN_END] = a.getResourceId(attr, 0);
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignParentStart:
                        rules[ALIGN_PARENT_START] = a.getBoolean(attr, false) ? TRUE : 0;
                        break;
                    case R.styleable.CustomRelativeLayout_Layout_layout_alignParentEnd:
            ...
            a.recycle();
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(Context c, AttributeSet attrs) { end constructor ");
        }

        public LayoutParams(int w, int h) {
            super(w, h);
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(int w, int h) { start constructor ");
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(int w, int h) { end constructor ");
        }
        ...
        public LayoutParams(ViewGroup.LayoutParams source) {
            super(source);
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(ViewGroup.LayoutParams source) { start constructor ");
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(ViewGroup.LayoutParams source) { end constructor ");
        }
        ...
        public LayoutParams(ViewGroup.MarginLayoutParams source) {
            super(source);
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(ViewGroup.MarginLayoutParams source) { start constructor ");
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(ViewGroup.MarginLayoutParams source) { end constructor ");
        }
        ...
        public LayoutParams(LayoutParams source) {
            super(source);
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(LayoutParams source) { start constructor ");
		...
		System.out.println("resp1onse CustomRelativeLayout: public LayoutParams(LayoutParams source) { end constructor ");
        }
...
//        }
         ...
         * (e.g., CENTER_IN_PARENT) or take a boolean value ({@link CustomRelativeLayout#TRUE}
		...
		System.out.println("resp1onse CustomRelativeLayout: public void addRule(int verb) { start void ");
            mRules[verb] = TRUE;
            mInitialRules[verb] = TRUE;
            mRulesChanged = true;
		System.out.println("resp1onse CustomRelativeLayout: public void addRule(int verb) { end void ");
        }
         ...
         *        or a boolean value (represented as {@link CustomRelativeLayout#TRUE}
         *        for true or 0 for false).  For verbs that don't refer to another sibling
         *        (for example, ALIGN_WITH_PARENT_BOTTOM) just use -1.
         * @see #addRule(int)
         */
        public void addRule(int verb, int anchor) {
		System.out.println("resp1onse CustomRelativeLayout: public void addRule(int verb, int anchor) { start void ");
            mRules[verb] = anchor;
            mInitialRules[verb] = anchor;
            mRulesChanged = true;
		System.out.println("resp1onse CustomRelativeLayout: public void addRule(int verb, int anchor) { end void ");
        }
		...
		System.out.println("resp1onse CustomRelativeLayout: public void removeRule(int verb) { start void ");
            mRules[verb] = 0;
            mInitialRules[verb] = 0;
            mRulesChanged = true;
		System.out.println("resp1onse CustomRelativeLayout: public void removeRule(int verb) { end void ");
        }

        private boolean hasRelativeRules() {
		System.out.println("resp1onse CustomRelativeLayout: private boolean hasRelativeRules() { start return ");
		System.out.println("resp1onse CustomRelativeLayout: private boolean hasRelativeRules() { end return ");
		...
		System.out.println("resp1onse CustomRelativeLayout: private void resolveRules(int layoutDirection) { start void ");
            ...
            mRulesChanged = false;
		System.out.println("resp1onse CustomRelativeLayout: private void resolveRules(int layoutDirection) { end void ");
        }
		...
		System.out.println("resp1onse CustomRelativeLayout: public int[] getRules(int layoutDirection) { start return ");
            if (hasRelativeRules() &&
		...
		System.out.println("resp1onse CustomRelativeLayout: public int[] getRules(int layoutDirection) { end return  =1");
            return mRules;
        }
         ...
         */
        public int[] getRules() {
		System.out.println("resp1onse CustomRelativeLayout: public int[] getRules() { start return ");
		System.out.println("resp1onse CustomRelativeLayout: public int[] getRules() { end return ");
            return mRules;
        }

        @Override
        public void resolveLayoutDirection(int layoutDirection) {
		System.out.println("resp1onse CustomRelativeLayout: public void resolveLayoutDirection(int layoutDirection) { start void ");
		...
		System.out.println("resp1onse CustomRelativeLayout: public void resolveLayoutDirection(int layoutDirection) { end void ");
        }
    }
    ...
    private static class DependencyGraph {
         ...
         */
        void clear() {
		System.out.println("resp1onse CustomRelativeLayout: void clear() { start void ");
            ...
            mKeyNodes.clear();
            mRoots.clear();
		System.out.println("resp1onse CustomRelativeLayout: void clear() { end void ");
        }
         ...
         */
        void add(View view) {
		System.out.println("resp1onse CustomRelativeLayout: void add(View view) { start void ");
            ...
            mNodes.add(node);
		System.out.println("resp1onse CustomRelativeLayout: void add(View view) { end void ");
        }
		...
		System.out.println("resp1onse CustomRelativeLayout: void getSortedViews(View[] sorted, int... rules) { start void ");
		...
		System.out.println("resp1onse CustomRelativeLayout: void getSortedViews(View[] sorted, int... rules) { end void ");
        }
		...
		System.out.println("resp1onse CustomRelativeLayout: private ArrayDeque<Node> findRoots(int[] rulesFilter) { start return ");
		...
		System.out.println("resp1onse CustomRelativeLayout: private ArrayDeque<Node> findRoots(int[] rulesFilter) { end return  =1");
            return roots;
        }
		...
		System.out.println("resp1onse CustomRelativeLayout: static Node acquire(View view) { start return ");
                Node node = sPool.acquire();
                if (node == null) {
                    node = new Node();
                }
                node.view = view;
		System.out.println("resp1onse CustomRelativeLayout: static Node acquire(View view) { end return  =1");
                return node;
            }

            void release() {
		System.out.println("resp1onse CustomRelativeLayout: void release() { start void ");
                view = null;
                dependents.clear();
                dependencies.clear();

                sPool.release(this);
		System.out.println("resp1onse CustomRelativeLayout: void release() { end void ");
            }
            /*
