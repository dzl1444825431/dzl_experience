...
////import com.dzl.test.listview.ListView;
//import com.dzl.test.listview.ListView;
//
//
///**
...
// */
////@Widget
//public class Spinner extends AbsSpinner2 implements OnClickListener {
...
//                    R.styleable.Spinner_popupBackground));
//
//            mPopup = popup;
...
//        setPopupBackgroundDrawable(mContext.getResources().getDrawable(resId));
//    }
//
//    /**
...
//        if (targetSdkVersion >= /*Build.VERSION_CODES.LOLLIPOP*/20
...
//    }
//
//    static class SavedState extends AbsSpinner2.SavedState {
...
//                public void onItemClick(AdapterView2 parent, View v, int position, long id) {
