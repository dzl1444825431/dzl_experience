...
//    private boolean headIsTransparent;//set loAlertHeader si Transparent
//
//    public AlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style,OnItemClickListener onItemClickListener,boolean headIsTransparent){
//        this.context = context;
//        if(style != null)this.style = style;
//        this.onItemClickListener = onItemClickListener;
//        this.headIsTransparent = headIsTransparent;
...
//        if(headIsTransparent){
//            loAlertHeader.setBackgroundResource(R.color.bgtransparent);
//        }
//        //标题和消息
